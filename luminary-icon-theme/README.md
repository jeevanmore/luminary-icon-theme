<p align="center">
  <img src="https://github.com/jeevanmore/luminary-icon-theme/blob/master/luminary-icon-theme/preview.png" alt="preview"/>
</p>
...
Luminary is a simple, easy on eyes and beautiful icon theme for GNU-Linux. This theme is to be used with desktop environment such as for lxde, xfce, gnome, etc.

Luminary icon theme is available in two variants:
